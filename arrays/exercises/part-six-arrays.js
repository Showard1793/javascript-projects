...
console.log(table);
//3) Use bracket notation to examine the difference between printing 'table' with one 
//index vs. two indices (table[][]).
console.log(table[0]);
...
hair = ["blond", "brown", "white"];

person = [eyes, hair]
city = ["St. Louis", "Chicago", "New York"];

identity = [person, city]

console.log(identity[0][0][2]);
