...
//1) Use bracket notation to replace ‘slinky’ with ‘space tether’. Print the array to 
//confirm the change.
cargoHold.splice(cargoHold.indexOf('slinky'), "space tether");
...
console.log(`${cargoHold} are the items and it has a length of ${cargoHold.length}`);